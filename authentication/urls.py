...
from .views import RegisterView, LoginView, SendOTPView, ResendOTPView, VerifyOTPView, ForgotPasswordView, PasswordResetView, GetAgentDetail, GetClientDetail, UpdateUserProfile
